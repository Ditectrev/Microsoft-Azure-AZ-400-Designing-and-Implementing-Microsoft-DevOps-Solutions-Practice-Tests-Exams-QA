...
| 108 | [Your company creates a web application. You need to recommend a solution that automatically sends to Microsoft Teams a daily summary of the exceptions that occur m the application. Which two Azure services should you recommend?](#your-company-creates-a-web-application-you-need-to-recommend-a-solution-that-automatically-sends-to-microsoft-teams-a-daily-summary-of-the-exceptions-that-occur-m-the-application-which-two-azure-services-should-you-recommend)
